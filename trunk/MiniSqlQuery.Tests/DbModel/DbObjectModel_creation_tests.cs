...
//            _dataService = new GenericSchemaService();
...
//        private IDatabaseSchemaService _dataService;
...
//        [Test]
//        public void SqlCeSchemaService_can_get_all_data_types()
//        {
//            SqlCeSchemaService service = new SqlCeSchemaService();
//            Dictionary<string, DbModelType> dbTypes = service.GetDbTypes(null);

//            //List<DbModelType> ary = new List<DbModelType>(dbTypes.Values);

//            Console.WriteLine(dbTypes.Count);
//            DbModelType nvarcharType = dbTypes["nvarchar"];
//            Assert.That(nvarcharType.Name, Is.EqualTo("nvarchar").IgnoreCase);
//            Assert.That(nvarcharType.Length, Is.EqualTo(4000));
//            Assert.That(nvarcharType.CreateFormat, Is.EqualTo("nvarchar({0})"));
//            Assert.That(nvarcharType.LiteralPrefix, Is.Not.Null);
//            Assert.That(nvarcharType.LiteralSuffix, Is.Not.Null);
//            Assert.That(nvarcharType.SystemType, Is.EqualTo(typeof(string)));

//            nvarcharType = dbTypes["decimal"];
//            Assert.That(nvarcharType.Name, Is.EqualTo("decimal").IgnoreCase);
//            Assert.That(nvarcharType.CreateFormat, Is.EqualTo("decimal({0}, {1})"));
//            Assert.That(nvarcharType.SystemType, Is.EqualTo(typeof(decimal)));
//        }
