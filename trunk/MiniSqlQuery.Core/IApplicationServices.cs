...
{
	/// <summary>The core services of the application.</summary>
	public interface IApplicationServices
	{
		...
		/// <summary>The Dependency Injection container.
		/// This container holds all major application components and plugins.
		/// See the "Configuration.xml" file in the main application for settings.</summary>
