...
{
	/// <summary>Stores instances of commands by type.</summary>
	public class CommandManager
	{
		/// <summary>The command cache.</summary>
		private static readonly Dictionary<Type, ICommand> CommandCache = new Dictionary<Type, ICommand>();

		/// <summary>Gets the command instance by <paramref name="commandTypeName"/>.</summary>
		...
		/// <summary>Gets or creates an instance of a command by type.</summary>
		...
		/// <summary>Gets command instance by it's partial name, e.g. "OpenFile".</summary>
