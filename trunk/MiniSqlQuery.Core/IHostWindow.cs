...
{
	/// <summary>Core functions of the main MDI application host Form.</summary>
	public interface IHostWindow
	{
		...
		/// <summary>The instance of the host form.</summary>
		...
		/// <summary>Adds an <see cref="ICommand"/> to the plugins menu.</summary>
		...
		/// <summary>Adds a command based button to the tool strip by <paramref name="index"/>.</summary>
		...
		/// <summary>Adds a seperator to the tool strip by <paramref name="index"/>.</summary>
		...
		/// <summary>Displays the <paramref name="frm"/> in the host window.</summary>
		...
		DialogResult DisplayMessageBox(Form source, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, MessageBoxOptions options, 
		...
		/// <summary>Gets the relevent menu item by name.</summary>
		...
		/// <summary>A testable way to pass command line arguements to the application.</summary>
		/// <param name="args">An array of command line arguements.</param>
		void SetArguments(string[] args);

		/// <summary>Sets the application cursor to <paramref name="cursor"/>.</summary>
		/// <param name="cursor">The new cursor mode.</param>
		void SetPointerState(Cursor cursor);

		/// <summary>Sets the status text of the host.</summary>
		/// <param name="source">The source form, for tracking MDI children.</param>
		/// <param name="text">The text to set.</param>
		void SetStatus(Form source, string text);

		/// <summary>Displays (and replaces if required) the database inspactor window.</summary>
		...
		/// <summary>Displays a "tool" window, like the database inspector etc.</summary>
