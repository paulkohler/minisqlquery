...
{
	/// <summary>Some basic helper functions.</summary>
	public static class Utility
	{
		/// <summary>Writes a default file if none present.</summary>
		...
		/// <summary>Resolves the full filename of the connection string file, by default in the application data folder
		...
		/// <summary>Returns an array of SQL provider types supported by the current platform.</summary>
		...
		/// <summary>Loads the connection string data from the file.</summary>
		...
		/// <summary>Loads the db connection definitions from an XML file.</summary>
		...
		/// <summary>The render safe schema object name.</summary>
		...
		/// <summary>Saves the <paramref name="definitionList"/> to the connection string file.</summary>
		...
		/// <summary>Shows the URL in the defaut browser.</summary>
		...
		/// <summary>Serializes the <paramref name="obj"/>.</summary>
		...
		/// <summary>Resolves the "(application data path)\MiniSqlQuery" for this user.</summary>
