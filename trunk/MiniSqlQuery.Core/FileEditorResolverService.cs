...
{
	/// <summary>Given a file name or extention the service will work out the most appropriate editor
	/// to use.</summary>
	/// <remarks>The editors need to be registered using the <see cref="Register"/> method.
	/// <example>
	/// <code>
	...
	public class FileEditorResolverService : IFileEditorResolver
	{
		...
		/// <summary>Gets the file types.</summary>
		...
		/// <summary>Registers the specified file editor descriptor.
		/// It is recommended to use the <see cref="IApplicationServices.RegisterEditor{TEditor}"/> method to
		/// set up the container correctly.</summary>
		...
		/// <summary>Resolves the editor instance from the container based on the filename.</summary>
		...
		/// <summary>Works out the "name" of the editor to use based on the <paramref name="extention"/>.</summary>
