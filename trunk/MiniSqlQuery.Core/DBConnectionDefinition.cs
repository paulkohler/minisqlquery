...
{
	/// <summary>Provides a defition of database connection by provider and name.</summary>
	[Serializable]
	public class DbConnectionDefinition
	{
		...
		/// <summary>Initializes static members of the <see cref="DbConnectionDefinition"/> class. </summary>
