...
{
	/// <summary>
	/// Used as a modal dialog, a <see cref="QueryBatch"/> is supplied and the used can 
	/// select one of the result sets. <see cref="DialogResult"/> is set to 
	/// <see cref="DialogResult.OK"/> on an OK exit.
	/// </summary>
